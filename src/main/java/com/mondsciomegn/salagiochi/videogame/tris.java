...
public class tris extends videoGame{
	public void gioca() {
	...
	public static void stampaGriglia(char[][] areaGioco) {
	    System.out.println("\n  0   1   2"); 
	    for (int i = 0; i < 3; i++) {
	        System.out.print(i + " "); 
	        for (int j = 0; j < 3; j++) {
	...
	public static int[] mossaCasuale(char[][] griglia) {
	...
	public static int tastiera(int riga) {
	...
	public static int tastiera(int riga, int colonna) {
		Scanner scanner = new Scanner(System.in);
